...
The first thing we want to do is create a new Project called *CITYNAMEuserXX-guestbook*.
Remember that Projects group resources together. Ensure that you replace
*CITYNAMEuserXX* with your correct user number:

	$ oc new-project CITYNAMEuserXX-guestbook

The *new-project* command will automatically switch you to use that Project. You
will see something like the following:

    Now using project "CITYNAMEuserXX-guestbook" on server "https://master.CITYNAME-roadshow.rhc-ose.labs.redhat.com:8443:8443".
...
You should see a list like the following:
    ...
    CITYNAMEuserXX-guestbook                  Active
    ose-roadshow-demo       OpenShift Roadshow Demo     Active
...
1. Select Project *CITYNAMEuserXX-guestbook* 
1. Select *Browse*
1. Select *Pods* 
